...
# Constants
$clientID       = "145fef69-7ecb-4c0c-ba12-0c32a1ce3f2d"         # CLIENT ID for application
$clientSecret   = "Y+A6UuPXm4eE5xKUTjO5fSGBup+qwurEHS81JpoZt6g=" # KEY for application.  Should Expire Feb 2018 - just substitute new one here.
$tenantdomain   = "yaleedu.onmicrosoft.com"                      # The target tenant's name
...
if ($oauth.access_token -ne $null) {   
    ...
    # built the URL for the request.  Need to generate this due to varying filter parameters among reports.
